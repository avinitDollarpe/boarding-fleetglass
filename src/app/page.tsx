    ...
    <div className="mx-auto flex min-h-screen w-full max-w-3xl flex-col justify-center gap-10 px-6 py-16">
      <div className="flex flex-col gap-4">
        ...
        <p className="max-w-xl text-muted-foreground">
          Chief hears a GitHub mention, a Slack alias, or a chat handoff, then Gilfoyle opens the task here. An active Cursor plan launches the agent. Anything else stays in blocked:cursor_plan.
        </p>
      </div>
