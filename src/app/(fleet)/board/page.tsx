      ...
      {parents.length === 0 ? (
        <div className="card flex flex-col gap-3 p-6">
          ...
          <p className="max-w-xl text-sm text-muted-foreground">
            Chief forwards a Slack mention, a GitHub mention, or a chat delegate. Gilfoyle creates the task here before any cloud agent starts. You can also add one by hand.
          </p>
        </div>
      ) : null}
